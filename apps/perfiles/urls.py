...
from . import views
from django.contrib.auth.views import LoginView, PasswordResetView, logout_then_login, PasswordResetCompleteView, PasswordResetConfirmView, PasswordChangeDoneView
